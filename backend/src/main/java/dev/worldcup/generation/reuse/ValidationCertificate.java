...
public record ValidationCertificate(String policyVersion, Instant referenceTime, Instant validatedAt,
        ...
        InterpretationReview allocationInterpretation, Verdict allocationComparable,
        Verdict allocationNoSemanticDuplicates, Verdict allocationFeasible, Review finalReview) {
