...
TD-51 최신 관측: v23은 단일 생성→독립 전체 검토→필요 시 Repair 1회·재검토로 전환했다. 검색 없는 hobby-solo/16 1회는 READY·같은 후보의 완주 저장·공유까지 PASS(127.012초/4회/$0.1380685/Repair 1회)다. 후속 32강은 185.026초/4회/$0.221852/Repair 1회 뒤 최종 그림 3개 중복 FAIL로 종료했다. 출력 잘림/시간 초과 없음, preview·완주 없음, 재추첨 없음이다. 현재 장부 $5.2955198/$6, 자동 충전 OFF. 일반 주방의 과잉 UNKNOWN·최초 검토의 중복 누락, v23 8강 실측·외부 사실/사람 평가 미완료는 남는다. 아래 과거 금액·FAIL, 18세트 첫 실행 11/18 및 R 사람 FAIL은 덮어쓰지 않는다. 상세는 `docs/CANDIDATE_ENGINE.md` TD-51 절이다.
